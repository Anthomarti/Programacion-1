"""
# Titulo: Desafío 4 Encapsulamiento
...
# Función que devuelve una lista de títulos de libros escritos por un autor
def get_titulos_de_libros(autor):
    titulos = []
...
print(get_titulos_de_libros(autor))