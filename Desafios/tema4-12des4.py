...
# Fecha: 13/10/2024
# Descripción:
# Piensa en otros atributos y métodos que
# podrías agregar a la clase `Autor` para
...
# Agregar premios a los autores
autor1.agregar_premio("Premio Nacional de Literatura")
autor2.agregar_premio("Premio Internacional de Literatura")
